...
class Target:
    ...
    def __init__(self): 
        self.capture = cv.CaptureFromFile('F:\\Project\\Video12\\sss.mov') 
    ...
    def run(self):
        ...
        while True:
            ...
            xpos=[]
            ypos=[]
            f1=cv2.imread("F:\\Project\\Video12\\rags.jpg")
            f2=cv2.imread("F:\\Project\\Video12\\rashmi.jpg")
            ...
            while contour and (flag1==1 or flag2==1):
                    #print "checktrack",n
